...
## Output directory for generated image files
...
SLIDES_INTERMEDIATE_DIR = pdf/temp
...
.PHONY: clean-temp
clean-temp: clean-latex ## Clean up aĺl intermediate files and directories
	rm -rf $(WEB_INTERMEDIATE_DIR) $(SLIDES_INTERMEDIATE_DIR) $(IMAGES_OUTPUT_DIR)

.PHONY: clean-latex
clean-latex: ## Clean up intermediate files generated by LaTeX
